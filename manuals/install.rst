...
-  "php": ">=7.0.0"
-  需要开启 gd 扩展
-  如果使用 Exif ，请开启 exif 扩展

使用Composer安装
================

FizeImage 支持使用 `Composer <https://www.phpcomposer.com/>`_ 安装，也是唯一官方推荐的安装方法。
...
.. code-block:: bash
  ...
  composer require fize/image
  
好了！一步到位，您现在可以开始使用 FizeImage 了，就是这么简单！~
